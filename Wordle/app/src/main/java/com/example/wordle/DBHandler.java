...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public boolean  login(String tryemail,String trypassword) {
        String[] columns = {
                "id"
        };
        ...
        String[] selectionArgs={tryemail,trypassword};
        Cursor cursor = db.query(TABLE_NAME,
                columns,
                selection,
                selectionArgs,
        ...
        //String TruePassword=db.rawQuery("SELECT password FROM " + TABLE_NAME +" WHERE email=?", new String[]{email}).toString();
        //TruePassword.trim();
